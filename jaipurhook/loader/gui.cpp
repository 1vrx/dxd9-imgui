...
void gui::Render() noexcept
{
	...
	//so much whitespace because aligned with center (prob better way to do this)
	ImGui::Begin("							 menutitle", &exit, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoTitleBar);
